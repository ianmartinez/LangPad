...
{
    private readonly Font charNameFont = new("Calibri", 12, FontStyle.Regular);
    private readonly Font textFont = new("Calibri", 42, FontStyle.Bold);
    public string CharName { get; set; } = "";

    public IpaToolTip() : base() => CreateTooltip();

    public IpaToolTip(IContainer Cont) : base(Cont) => CreateTooltip();
