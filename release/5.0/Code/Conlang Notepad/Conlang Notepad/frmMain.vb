  ...
  ByVal size As Size, Optional ByVal preserveAspectRatio As Boolean = True) As Image
    ...
    Private Sub ApplyStyle(ByVal rtb As ExtendedRichTextBox, ByVal FontStyle As FontStyle)
        If rtb.SelectionLength > 0 Then
            ...
            Dim Ending As Integer = rtb.SelectionLength + Start - 1
            ...
            rtb.SelectionLength = Ending - Start + 1
        Else
            rtb.SelectionFont = New Font(rtb.SelectionFont, rtb.SelectionFont.Style Xor FontStyle)
        End If
    ...
    Private Sub ApplyFontChange(ByVal rtb As ExtendedRichTextBox, ByVal Font As Font)
        If rtb.SelectionLength > 0 Then
            ...
            For i = Start To Ending
                rtb.SelectionStart = i
                rtb.SelectionLength = 1
                rtb.SelectionFont = New Font(Font, rtb.SelectionFont.Style)
            Next
            rtb.SelectionStart = Start
            rtb.SelectionLength = Ending - Start + 1
        Else
    ...
    Private Sub RichTextEditor_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If My.Settings.QuickUp = True Then
            btnClipArt.Hide()
            btnClipArtTab.Hide()
        End If
    ...
    Private Sub nudSize_ValueChanged(sender As Object, e As EventArgs) Handles nudSize.ValueChanged
        ApplyFontChange(SelectedDocument, New Font(SelectedDocument.SelectionFont.FontFamily, nudSize.Value))
    End Sub
