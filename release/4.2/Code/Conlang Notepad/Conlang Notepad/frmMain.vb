  ...
  ByVal size As Size, Optional ByVal preserveAspectRatio As Boolean = True) As Image
    ...
    Private Sub cbFont_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbFont.SelectedIndexChanged
        ...
        If Not SelectedDocument.SelectionFont Is Nothing Then
            ...
            End If
        End If
        If SelectedDocument.SelectionFont Is Nothing Then
            Dim Start As Integer = SelectedDocument.SelectionStart
            Dim Ending As Integer = SelectedDocument.SelectionLength + Start - 1
            For i = Start To Ending
                SelectedDocument.SelectionStart = i
                SelectedDocument.SelectionLength = 1
                SelectedDocument.SelectionFont = NewFont
            Next
            SelectedDocument.SelectionStart = Start
            SelectedDocument.SelectionLength = Ending - Start + 1
        Else
            SelectedDocument.SelectionFont = NewFont
        End If
    ...
    Private Sub btnBold_CheckedChanged(sender As Object, e As EventArgs) Handles btnBold.Click
        If SelectedDocument.SelectionFont Is Nothing Then
            Dim Start As Integer = SelectedDocument.SelectionStart
            Dim Ending As Integer = SelectedDocument.SelectionLength + Start - 1
            For i = Start To Ending
                SelectedDocument.SelectionStart = i
                SelectedDocument.SelectionLength = 1
                SelectedDocument.SelectionFont = New Font(SelectedDocument.SelectionFont, SelectedDocument.SelectionFont.Style Xor FontStyle.Bold)
            Next
            SelectedDocument.SelectionStart = Start
            SelectedDocument.SelectionLength = Ending - Start + 1
        Else
    ...
    Private Sub btnItalic_CheckedChanged(sender As Object, e As EventArgs) Handles btnItalic.Click
        If SelectedDocument.SelectionFont Is Nothing Then
            Dim Start As Integer = SelectedDocument.SelectionStart
            Dim Ending As Integer = SelectedDocument.SelectionLength + Start - 1
            For i = Start To Ending
                SelectedDocument.SelectionStart = i
                SelectedDocument.SelectionLength = 1
                SelectedDocument.SelectionFont = New Font(SelectedDocument.SelectionFont, SelectedDocument.SelectionFont.Style Xor FontStyle.Italic)
            Next
            SelectedDocument.SelectionStart = Start
            SelectedDocument.SelectionLength = Ending - Start + 1
        Else
    ...
    Private Sub btnUnderline_CheckedChanged(sender As Object, e As EventArgs) Handles btnUnderline.Click
        If SelectedDocument.SelectionFont Is Nothing Then
            Dim Start As Integer = SelectedDocument.SelectionStart
            Dim Ending As Integer = SelectedDocument.SelectionLength + Start - 1
            For i = Start To Ending
                SelectedDocument.SelectionStart = i
                SelectedDocument.SelectionLength = 1
                SelectedDocument.SelectionFont = New Font(SelectedDocument.SelectionFont, SelectedDocument.SelectionFont.Style Xor FontStyle.Underline)
            Next
            SelectedDocument.SelectionStart = Start
            SelectedDocument.SelectionLength = Ending - Start + 1
        Else
    ...
    Private Sub btnStrikethrough_CheckedChanged(sender As Object, e As EventArgs) Handles btnStrikethrough.Click
        If SelectedDocument.SelectionFont Is Nothing Then
            Dim Start As Integer = SelectedDocument.SelectionStart
            Dim Ending As Integer = SelectedDocument.SelectionLength + Start - 1
            For i = Start To Ending
                SelectedDocument.SelectionStart = i
                SelectedDocument.SelectionLength = 1
                SelectedDocument.SelectionFont = New Font(SelectedDocument.SelectionFont, SelectedDocument.SelectionFont.Style Xor FontStyle.Strikeout)
            Next
            SelectedDocument.SelectionStart = Start
            SelectedDocument.SelectionLength = Ending - Start + 1
        Else
    ...
    Private Sub nudSize_ValueChanged(sender As Object, e As EventArgs) Handles nudSize.ValueChanged
        ...
        If SelectedDocument.SelectionFont Is Nothing Then
            ...
            For i = Start To Ending
                SelectedDocument.SelectionStart = i
                SelectedDocument.SelectionLength = 1
                SelectedDocument.SelectionFont = New Font(SelectedDocument.SelectionFont.FontFamily, nudSize.Value, SelectedDocument.SelectionFont.Style)
            Next
            SelectedDocument.SelectionStart = Start
            SelectedDocument.SelectionLength = Ending - Start + 1
        Else
    ...
    Private Sub btnPageSetup_Click(sender As Object, e As EventArgs) Handles btnPageSetup.Click
        dlgSetup.Document = PrintDocument1
        dlgSetup.ShowDialog()
    End Sub
