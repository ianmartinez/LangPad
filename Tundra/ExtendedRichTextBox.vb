...
Public Class ExtendedRichTextBox
    ...
    Public Sub InsertTable(ByVal Rows As Integer, ByVal Columns As Integer, Optional ByVal Width As Integer = 100)
        ...
        Dim NewRTB As New ExtendedRichTextBox
        Dim RTFBoilerPlate As String = "{\rtf1\ansi\ansicpg1252\deff0\deflang1033{\fonttbl{\f0\fnil\fcharset0 Microsoft Sans Serif;}}\viewkind4\uc1\pard\f0\fs16"
    ...
    Private Sub ExtendedRichTextBox_ContentsResized(sender As Object, e As ContentsResizedEventArgs) Handles Me.ContentsResized
