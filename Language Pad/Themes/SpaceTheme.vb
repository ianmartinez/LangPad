Module clsSpaceColors
    Public clrSpaceHorBG_GrayBlue As Color = Color.FromArgb(255, 233, 236, 250)
    Public clrSpaceHorBG_White As Color = Color.FromArgb(255, 244, 247, 252)
    Public clrSpaceSubmenuBG As Color = Color.FromArgb(255, 240, 240, 240)
    Public clrSpaceImageMarginBlue As Color = Color.FromArgb(255, 212, 216, 230)
    Public clrSpaceImageMarginWhite As Color = Color.FromArgb(255, 216, 226, 235)
    Public clrSpaceImageMarginLine As Color = Color.FromArgb(255, 123, 133, 142)
    Public clrSpaceSelectedBG_Blue As Color = Color.FromArgb(255, 186, 228, 246)
    Public clrSpaceSelectedBG_Header_Blue As Color = Color.FromArgb(255, 146, 202, 230)
    Public clrSpaceSelectedBG_White As Color = Color.FromArgb(255, 241, 248, 251)
    Public clrSpaceSelectedBG_Border As Color = Color.FromArgb(255, 179, 155, 133)
    Public clrSpaceSelectedBG_Drop_Blue As Color = Color.FromArgb(255, 139, 195, 225)
    Public clrSpaceSelectedBG_Drop_Border As Color = Color.FromArgb(255, 179, 155, 133)
    Public clrSpaceMenuBorder As Color = Color.FromArgb(255, 160, 160, 160)
    Public clrSpaceCheckBG As Color = Color.FromArgb(255, 206, 237, 250)
    ...
    Public clrSpaceToolstripBtn_Border As Color = Color.FromArgb(255, 179, 155, 133)
    ...
    Public clSpace_SelectedBorder As Color = Color.FromArgb(255, 185, 169, 43)
    Public clSpace_SelectedShadow As Color = Color.FromArgb(0, 0, 0, 0)

    Public clSpace_Drop1 As Color = Color.FromArgb(255, 255, 243, 188)
    Public clSpace_Drop2 As Color = Color.FromArgb(255, 255, 218, 134)
    Public clSpace_DropBorder As Color = Color.FromArgb(255, 205, 149, 63)
    Public clSpace_DropShadow As Color = Color.FromArgb(0, 0, 0, 0)

    Public clrSpaceSep As Color = Color.FromArgb(255, 79, 79, 79)
    Public clrSpaceSepWhite As Color = Color.FromArgb(200, 255, 255, 255)
...
Public Class clsSpaceMenuRenderer
    ...
    Protected Overrides Sub OnRenderToolStripBackground(ByVal e As ToolStripRenderEventArgs)
        ...
        Dim b As New Drawing2D.LinearGradientBrush(e.AffectedBounds, clrSpaceHorBG_Color1, clrSpaceHorBG_Color2,
    ...
    Protected Overrides Sub OnRenderImageMargin(ByVal e As ToolStripRenderEventArgs)
        ...
        Dim b As New Drawing2D.LinearGradientBrush(e.AffectedBounds, clrSpaceHorBG_Color2, clrSpaceHorBG_Color1,
            Drawing2D.LinearGradientMode.Vertical)

        '// Shadow at the right of image margin
        Dim DarkLine As New SolidBrush(clrSpaceImageMarginLine)
        ...
        '// Gray background
        Dim SubmenuBGbrush As New SolidBrush(clrSpaceSubmenuBG)
        Dim rect3 As New Rectangle(0, 0, e.ToolStrip.Width, e.ToolStrip.Height)

        '// Border
        Dim borderPen As New Pen(clrSpaceMenuBorder)
    ...
    Protected Overrides Sub OnRenderMenuItemBackground(ByVal e As ToolStripItemRenderEventArgs)
        ...
        If e.Item.Enabled Then
            If e.Item.IsOnDropDown = False AndAlso e.Item.Selected Then
                ...
                Dim b As New Drawing2D.LinearGradientBrush(rect, clSpace_Selected1, clSpace_Selected2, Drawing2D.LinearGradientMode.Vertical)
                Dim b2 As New SolidBrush(clrSpaceToolstripBtn_Border)

                e.Graphics.FillRectangle(b, rect)
                clsColors.DrawRoundedRectangle(e.Graphics, rect.Left - 1, rect.Top - 1, rect.Width, rect.Height + 1, 2, clrSpaceToolstripBtn_Border)
                clsColors.DrawRoundedRectangle(e.Graphics, rect.Left - 2, rect.Top - 2, rect.Width + 2, rect.Height + 3, 2, clSpace_SelectedShadow)
            ...
            If CType(e.Item, ToolStripMenuItem).DropDown.Visible AndAlso e.Item.IsOnDropDown = False Then 'CType(e.Item, ToolStripMenuItem).OwnerItem Is Nothing Then
                Dim rect As New Rectangle(3, 2, e.Item.Width - 6, e.Item.Height - 4)
                Dim b As New Drawing2D.LinearGradientBrush(rect, clSpace_Drop1, clSpace_Drop2, Drawing2D.LinearGradientMode.Vertical)
                Dim b2 As New SolidBrush(clrSpaceSelectedBG_Drop_Border)

                e.Graphics.FillRectangle(b, rect)
                clsColors.DrawRoundedRectangle(e.Graphics, rect.Left - 1, rect.Top - 1, rect.Width, rect.Height + 1, 2, clrSpaceSelectedBG_Drop_Border)
                clsColors.DrawRoundedRectangle(e.Graphics, rect.Left - 2, rect.Top - 2, rect.Width + 2, rect.Height + 3, 2, clSpace_DropShadow)
                e.Item.ForeColor = Color.Black
            End If
        End If
    End Sub
...
Public Class clsSpaceToolstripRenderer
    ...
    Protected Overrides Sub OnRenderSeparator(ByVal e As ToolStripSeparatorRenderEventArgs)
        ...
        If e.ToolStrip.Orientation = Orientation.Vertical Then
            ...
            e.Graphics.FillRectangle(New SolidBrush(clrSpaceSep), rect)
            e.Graphics.FillRectangle(New SolidBrush(clrSpaceSepWhite), rect2)
        Else
    ...
    Protected Overrides Sub OnRenderButtonBackground(ByVal e As ToolStripItemRenderEventArgs)
        ...
        If e.Item.Pressed Then
            ...
            Dim rect As New Rectangle(1, 1, e.Item.Width - 2, e.Item.Height - 2)
            Dim b As New Drawing2D.LinearGradientBrush(rect, clSpace_Drop1, clSpace_Drop2, Drawing2D.LinearGradientMode.Vertical)
            Dim b2 As New SolidBrush(clSpace_DropBorder)
