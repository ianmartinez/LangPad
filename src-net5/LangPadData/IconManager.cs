...
namespace LangPadData
{
    ...
    public static class IconManager
    {
        ...
        /// <returns></returns>
        public static Stream Get(string name, IconSize iconSize, IconResolution iconResolution)
        {
            string folder;
            ...
            var resourceName = string.Format("LangPadData.Resources.{0}.{1}.png", folder, name);
